	...
	public LForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i = LDao.save(name, password, email, address, city, contact);
				if (i > 0) {
					JOptionPane.showMessageDialog(LForm.this, "Librarian added successfully!");
					AdSuccess.main(new String[] {});
					frame.dispose();

				} else {
					JOptionPane.showMessageDialog(LForm.this, "Sorry, unable to save!");
				}
			}
		});
